...
export declare type ContactFilters = {
    search?: string;
    status?: string;
    source?: string;
    priority?: string;
...
export declare type ContactListResponse = {
    contacts: Contact[];
    total: number;
    page: number;
    pages: number;
...
export declare type CreatePatientDTO = {
    firstName: string;
    lastName: string;
    email?: string;
    phone: string;
...
export declare type Patient = CreatePatientDTO & {
    id?: string;
    _id?: string;
    emergencyContact?: {
        name: string;
...
export declare type CreateAppointmentDTO = {
...
export declare type Appointment = CreateAppointmentDTO & {
    id?: string;
    _id?: string;
...
export declare type AppointmentType = {
    id?: string;
    _id?: string;
    name?: string;
    description?: string;
...
export declare type DashboardStats = {
    contacts: {
        total: number;
        byStatus: Array<{
            _id: string;
...
export declare type FormTemplate = {
    id?: string;
    _id?: string;
    name: string;
    description?: string;
...
export declare type CreateFormResponse = {
    templateId: string;
    patientId: string;
...
export declare type RegisterFormData = {
    name: string;
    email: string;
    password: string;
...
export declare type BatchUpdateResult = {
    modifiedCount: number;
    matchedCount: number;
};
export declare type DuplicateContactGroup = {
    email: string;
    contacts: Contact[];
    count: number;
};
...
export declare type CreateCalendarEventRequest = {
    title: string;
    start: string | Date;
    end: string | Date;
    patientId?: string;
...
export declare type AvailabilityQuery = {
    clinicId?: string;
    providerId?: string;
    appointmentTypeId: string;
    date: Date;
...
export declare type TimestampString = string;
