...
const ContactForm: React.FC = () => {
    ...
    const validateForm = (data: ContactFormData): FormErrors => {
        ...
        if (!data.name) {
            ...
            newErrors.name =
                'Nome deve ter entre 2 e 100 caracteres e conter apenas letras, espaços, hífens, apostrofes e pontos';
        }
        ...
        if (!data.phone) {
            ...
            newErrors.phone =
                'Digite um telefone válido (10-20 caracteres, apenas números, espaços, hífens, parênteses e +)';
        }
    ...
    return (
        <section id="contact" className="contact-form-section">
            ...
            <form onSubmit={handleSubmit} className="contact-form" noValidate>
                {errors.general && (
                    <div className="contact-form__error contact-form__error--general">{errors.general}</div>
                )}
                ...
                <button type="submit" disabled={isSubmitting} className="contact-btn" aria-describedby="submit-help">
                    {isSubmitting ? (
                        <>
