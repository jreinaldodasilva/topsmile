            ...
            return (
                <div className="error-boundary error-boundary--page">
                    <div className="error-boundary__container">
                        ...
                        <p>
                            Desculpe, mas algo inesperado aconteceu. Este erro foi registrado e nossa equipe irá
                            investigar.
                        </p>
                        {this.state.errorId && (
                        ...
                        <div className="error-boundary__support">
                            ...
                            <p className="error-boundary__support-text">
                                Se o problema persistir, entre em contato com o suporte técnico e forneça o ID do erro
                                acima.
                            </p>
                        </div>
                        {process.env.NODE_ENV === 'development' && (
