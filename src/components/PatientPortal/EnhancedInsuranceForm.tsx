      ...
      <section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
          <Input
            ...
            onChange={(e) => setFormData({ ...formData, coverageDetails: { ...formData.coverageDetails, annualMaximum: parseFloat(e.target.value) || 0 } })}
          />
          <Input
            label="Franquia (R$)"
            type="number"
            ...
            onChange={(e) => setFormData({ ...formData, coverageDetails: { ...formData.coverageDetails, deductible: parseFloat(e.target.value) || 0 } })}
          />
          <Input
            ...
            onChange={(e) => setFormData({ ...formData, coverageDetails: { ...formData.coverageDetails, deductibleMet: parseFloat(e.target.value) || 0 } })}
          />
          <Input
            ...
            onChange={(e) => setFormData({ ...formData, coverageDetails: { ...formData.coverageDetails, coinsurance: parseFloat(e.target.value) || 0 } })}
          />
          <Input
            label="Copagamento (R$)"
            type="number"
            ...
            onChange={(e) => setFormData({ ...formData, coverageDetails: { ...formData.coverageDetails, copay: parseFloat(e.target.value) || 0 } })}
          />
        </div>
      </section>
