        ...
        <div className="payment-retry-modal-overlay">
            <div className="payment-retry-modal">
                <div className="modal-header">
                    ...
                    <button className="modal-close-button" onClick={onClose} disabled={isRetrying}>
                ...
                <div className="modal-footer">
                    <button className="cancel-button" onClick={onClose} disabled={isRetrying}>
                        Cancel
                    </button>

                    {canRetry && (
                        <button className="retry-button" onClick={handleRetry} disabled={isRetrying || !canRetry}>
                            {isRetrying ? (
                                <>
                                    <svg
