    ...
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <section>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          {DAYS.map(({ key, label }) => (
            <div key={key} style={{ display: 'grid', gridTemplateColumns: '200px 1fr 1fr 100px', gap: '15px', alignItems: 'center', padding: '10px', border: '1px solid #e0e0e0', borderRadius: '8px' }}>
              ...
              <Input
                ...
                disabled={!workingHours[key].isWorking}
              />
              <span style={{ textAlign: 'center', color: workingHours[key].isWorking ? '#10b981' : '#6b7280' }}>
