...
const ContactList: React.FC<ContactListProps> = React.memo(({ initialFilters }) => {
    ...
    const handleCreateContact = useCallback(
        async (contact: Omit<Contact, '_id' | 'createdAt' | 'updatedAt'>) => {
            try {
    ...
    const handleStatusUpdate = useCallback(
        async (contactId: string, newStatus: Contact['status']) => {
            try {
                if (newStatus) {
    ...
    const handleSelectContact = useCallback(
        (contactId: string | undefined, selected: boolean) => {
            if (!contactId) return;
        ...
        async (status: Contact['status']) => {
            ...
            setConfirmDialog({
                ...
                onConfirm: async () => {
                    ...
                    try {
                        const result = await apiService.contacts.batchUpdate(
    ...
    return (
        <div className="contact-list">
            ...
            {isCreateModalOpen && (
                <CreateContactModal onClose={() => setIsCreateModalOpen(false)} onCreate={handleCreateContact} />
            )}

            {selectedContact && <ViewContactModal contact={selectedContact} onClose={() => setSelectedContact(null)} />}
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            aria-sort={
                                                sort.name ? (sort.name === 1 ? 'ascending' : 'descending') : 'none'
                                            }
                                        >
                                        ...
                                        <th
                                            ...
                                            aria-sort={
                                                sort.email ? (sort.email === 1 ? 'ascending' : 'descending') : 'none'
                                            }
                                        >
                                        ...
                                        <th
                                            ...
                                            aria-sort={
                                                sort.clinic ? (sort.clinic === 1 ? 'ascending' : 'descending') : 'none'
                                            }
                                        >
                                        ...
                                        <th
                                            ...
                                            aria-sort={
                                                sort.status ? (sort.status === 1 ? 'ascending' : 'descending') : 'none'
                                            }
                                        >
                    ...
                    {contactsList.length > 0 && pages > 1 && (
                        <div className="pagination">
                            <div className="pagination-info">
                                Exibindo {Math.min((currentPage - 1) * limit + 1, total)} -{' '}
                                {Math.min(currentPage * limit, total)} de {total} contatos
                            </div>
