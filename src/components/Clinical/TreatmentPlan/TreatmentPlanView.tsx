...
export const TreatmentPlanView: React.FC<TreatmentPlanViewProps> = ({
        ...
        <div className="presentation-content">
          ...
          {plan.phases.map((phase: any) => (
            <div key={phase.phaseNumber} className="presentation-phase">
              <h2>Fase {phase.phaseNumber}: {phase.title}</h2>
          ...
          <div className="presentation-summary">
            ...
            <p>Total: <strong>R$ {plan.totalCost.toFixed(2)}</strong></p>
            <p>Cobertura do Seguro: <strong>R$ {plan.totalInsuranceCoverage.toFixed(2)}</strong></p>
            <p>Sua Responsabilidade: <strong>R$ {plan.totalPatientCost.toFixed(2)}</strong></p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="treatment-plan-view">
      ...
      {plan.description && (
        <p className="plan-description-view">{plan.description}</p>
      )}
        ...
        {plan.phases.map((phase: any) => (
          <div key={phase.phaseNumber} className="phase-view">
            <div className="phase-header-view">
              <h3>Fase {phase.phaseNumber}: {phase.title}</h3>
