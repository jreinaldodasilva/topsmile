    ...
    return (
        <div className="phase-manager">
            <div className="phase-header">
                ...
                />
                {canRemove && (
                    <button onClick={onRemove} className="remove-phase-btn">
                        ×
                    </button>
                )}
            </div>
                        ...
                        <tbody>
                            {phase.procedures.map((proc, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td>
                                        <button onClick={() => onRemoveProcedure(idx)} className="remove-proc-btn">
                                            ×
                                        </button>
                                    </td>
                                </tr>
            ...
            {showSelector ? (
                <div className="selector-container">
                    <ProcedureSelector
                        ...
                        patientId={patientId}
                    />
                    <button onClick={() => setShowSelector(false)} className="cancel-selector-btn">
                        Cancelar
                    </button>
                </div>
            ) : (
                <button onClick={() => setShowSelector(true)} className="add-procedure-btn">
