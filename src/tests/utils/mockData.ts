...
export const generateMockPatient = (overrides = {}) => {
    ...
    return {
        ...
        medicalHistory: {
            allergies: faker.helpers.arrayElements(['Penicilina', 'Látex', 'Anestésico local', 'Nenhuma'], {
                min: 0,
                max: 2
            }),
            medications: faker.helpers.arrayElements(['Aspirina', 'Ibuprofeno', 'Paracetamol', 'Nenhum'], {
                min: 0,
                max: 2
            }),
            conditions: faker.helpers.arrayElements(['Diabetes', 'Hipertensão', 'Cardiopatia', 'Nenhuma'], {
                min: 0,
                max: 2
            }),
...
export const generateBrazilianState = () =>
