    ...
    const TestComponent = () => {
        ...
        return (
            <div>
                ...
                <button
                    onClick={() => {
                        notificationId = showError('Error', 'Error message');
                    }}
                >
                    Show Error
                </button>
                <button
                    onClick={() => {
                        notificationId = showWarning('Warning', 'Warning message');
                    }}
                >
                    Show Warning
                </button>
                <button
                    onClick={() => {
                        notificationId = showInfo('Info', 'Info message');
                    }}
                >
                    Show Info
                </button>
                <button
                    onClick={() => {
                        notificationId = showSuccess('Success', 'Success message');
                    }}
                >
                    Show Success
                </button>
