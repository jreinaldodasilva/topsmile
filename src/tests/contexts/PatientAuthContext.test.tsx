...
describe('PatientAuthContext', () => {
    ...
    const TestComponent = () => {
        const { login, logout, isAuthenticated, loading, error, patientUser, clearError, refreshPatientData } =
            usePatientAuth();
        ...
        return (
            <div>
                ...
                <div data-testid="user-info">{patientUser ? `Patient: ${patientUser.patient.name}` : 'No User'}</div>
                <button onClick={() => login('patient@example.com', 'password')}>Login</button>
                <button onClick={() => logout()}>Logout</button>
                <button onClick={clearError}>Clear Error</button>
                <button onClick={refreshPatientData}>Refresh Patient Data</button>
            </div>
        );
    };
