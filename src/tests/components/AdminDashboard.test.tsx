...
import { createMockApiResponse, createMockAppointment, createMockPatient } from '../utils/testHelpers';
...
describe('AdminDashboard', () => {
    beforeEach(() => {
        ...
        (apiService.patients.getAll as jest.Mock).mockResolvedValue(createMockApiResponse([createMockPatient()]));
    });
