...
export async function request<T = any>(endpoint: string, options: RequestOptions = {}): Promise<HttpResponse<T>> {
    ...
    const makeRequest = async () => {
        ...
        const needsCsrf =
            ['POST', 'PUT', 'PATCH', 'DELETE'].includes(restOfOptions.method || 'GET') &&
