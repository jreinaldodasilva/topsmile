                                        ...
                                        <Route
                                            ...
                                            element={
                                                <ErrorBoundary level="page" context="forms-page">
                                                    <LazyRoutes.FormRendererPage templateId="default" />
                                                </ErrorBoundary>
                                            }
                                        />
                                        <Route
                                                    ...
                                                    <Routes>
                                                        <Route
                                                            ...
                                                            element={
                                                                <ErrorBoundary
                                                                    level="page"
                                                                    context="patient-login-page"
                                                                >
                                                                    <LazyRoutes.PatientLoginPage />
                                                                </ErrorBoundary>
                                                            }
                                                        />
                                                        <Route
                                                            ...
                                                            element={
                                                                <ErrorBoundary
                                                                    level="page"
                                                                    context="patient-register-page"
                                                                >
                                                                    <LazyRoutes.PatientRegisterPage />
                                                                </ErrorBoundary>
                                                            }
                                                        />
                                                        <Route
                                                        ...
                                                        <Route
                                                            ...
                                                            element={
                                                                <PatientProtectedRoute>
                                                                    ...
                                                                    >
                                                                        <LazyRoutes.PatientAppointmentsList />
                                                                    </ErrorBoundary>
                                                                </PatientProtectedRoute>
                                                            }
                                                        />
                                                        <Route
                                                            ...
                                                            element={
                                                                <PatientProtectedRoute>
                                                                    <ErrorBoundary
                                                                        level="page"
                                                                        context="patient-appointment-booking"
                                                                    >
                                                                        <LazyRoutes.PatientAppointmentBooking />
                                                                    </ErrorBoundary>
                                                                </PatientProtectedRoute>
                                                            }
                                                        />
                                                        <Route
                                                            ...
                                                            element={
                                                                <PatientProtectedRoute>
                                                                    <ErrorBoundary
                                                                        level="page"
                                                                        context="patient-appointment-detail"
                                                                    >
                                                                        <LazyRoutes.PatientAppointmentDetail />
                                                                    </ErrorBoundary>
                                                                </PatientProtectedRoute>
                                                            }
                                                        />
                                                        ...
                                                        <Route
                                                            ...
                                                            element={
                                                                <PatientProtectedRoute>
                                                                    ...
                                                                    >
                                                                        <LazyRoutes.PatientMedicalRecords />
                                                                    </ErrorBoundary>
                                                                </PatientProtectedRoute>
                                                            }
                                                        />
                                                        <Route
                                                            ...
                                                            element={
                                                                <PatientProtectedRoute>
                                                                    <ErrorBoundary
                                                                        level="page"
                                                                        context="patient-prescriptions"
                                                                    >
                                                                        <LazyRoutes.PatientPrescriptions />
                                                                    </ErrorBoundary>
                                                                </PatientProtectedRoute>
                                                            }
                                                        />
                                                        ...
                                                        <Route
                                                            ...
                                                            element={
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <LazyRoutes.AppointmentCalendar />
                                                                    </ErrorBoundary>
                                                                </ProtectedRoute>
                                                            }
                                                        />
                                                        <Route
                                                            ...
                                                            element={
                                                                ...
                                                                >
                                                                    <ErrorBoundary
                                                                        level="page"
                                                                        context="operatory-management"
                                                                    >
                                                                        <LazyRoutes.OperatoryManagement />
                                                                    </ErrorBoundary>
                                                                </ProtectedRoute>
                                                            }
                                                        />
