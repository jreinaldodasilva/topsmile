                    ...
                    <div>
                        ...
                        {!isEditing ? (
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                                <div>
                                    <p>
                                        <strong>Nome:</strong> {patient.firstName} {patient.lastName}
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <strong>Gênero:</strong> {patient.gender || 'Não informado'}
                                    </p>
                                    <p>
                        ...
                        {isEditing && (
                            <Modal isOpen={isEditing} onClose={handleCancel} title="Editar Paciente" size="lg">
                                <EnhancedPatientForm
                                    patient={patient}
                                    onSave={async data => {
                                        if (!id) return;
                    ...
                    <div>
                        ...
                        {notesError && (
                            ...
                            >
                                ...
                                <button onClick={fetchClinicalNotes} style={{ marginTop: '10px', padding: '5px 10px' }}>
                                    Tentar Novamente
                                </button>
                            </div>
                        )}
                        {loadingNotes ? (
                            ...
                            !notesError && <NotesTimeline notes={clinicalNotes} onViewNote={handleViewNote} />
                        )}
                    </div>
                )}
                    ...
                    <div>
                        ...
                        {insuranceError && (
                            ...
                            >
                                ...
                                <button onClick={fetchInsurances} style={{ marginTop: '10px', padding: '5px 10px' }}>
                                    Tentar Novamente
                                </button>
                            </div>
                        )}
                                ...
                                {insurances.length === 0 ? (
                                    ...
                                    insurances.map(ins => (
                                        ...
                                        >
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <p style={{ color: '#666', margin: '5px 0' }}>
                                                        Seguro {ins.type === 'primary' ? 'Principal' : 'Secundário'}
                                                    </p>
                                                </div>
                                                <div style={{ display: 'flex', gap: '10px' }}>
                                                    <button
                                            ...
                                            >
                                                <p>
                                                    <strong>Apólice:</strong> {ins.policyNumber}
                                                </p>
                                                <p>
                                                    <strong>Grupo:</strong> {ins.groupNumber || 'N/A'}
                                                </p>
                                                <p>
                                                    <strong>Titular:</strong> {ins.subscriberName}
                                                </p>
                                                <p>
                                                    <strong>Relacionamento:</strong> {ins.subscriberRelationship}
                                                </p>
                                                <p>
                                                    <strong>Vigência:</strong>{' '}
                                                    {new Date(ins.effectiveDate).toLocaleDateString('pt-BR')} -{' '}
                                                    {ins.expirationDate
                                                        ? new Date(ins.expirationDate).toLocaleDateString('pt-BR')
                                                        : 'Indeterminado'}
                                                </p>
                                                {ins.coverageDetails && (
                                                    <p>
                                                        <strong>Máximo Anual:</strong> R${' '}
                                                        {ins.coverageDetails.annualMaximum?.toFixed(2) || '0.00'}
                                                    </p>
                                                )}
                                            </div>
                                        </div>
                    ...
                    <div>
                        ...
                        {prescriptionError && (
                            ...
                            >
                                ...
                                <button onClick={fetchPrescriptions} style={{ marginTop: '10px', padding: '5px 10px' }}>
                                    Tentar Novamente
                                </button>
                            </div>
                        )}
