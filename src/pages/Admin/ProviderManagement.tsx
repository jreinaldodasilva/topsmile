                        ...
                        <div className="filters-row">
                            ...
                            <div className="filter-group">
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        setSort({ [Object.keys(sort)[0]]: sort[Object.keys(sort)[0]] === 1 ? -1 : 1 })
                                    }
                                >
                                        ...
                                        <div className="provider-footer">
                                            ...
                                            <div className="provider-actions">
                                                ...
                                                <button
                                                    className="btn btn-sm btn-outline"
                                                    onClick={() =>
                                                        navigate(`/admin/appointments?providerId=${provider._id}`)
                                                    }
                                                    title="Ver agenda"
                                                >
                                                    <svg
                                    ...
                                    <div className="provider-details-modal">
                                        ...
                                        <div className="detail-section">
                                            ...
                                            <div className="working-hours-grid">
                                                {Object.entries(selectedProvider.workingHours || {}).map(
                                                    ([day, hours]) => {
                                                        const dayNames: Record<string, string> = {
                                                        ...
                                                        return (
                                                            <div key={day} className="working-hours-item">
                                                                ...
                                                                <span
                                                                    className={`hours ${hours.isWorking ? 'working' : 'not-working'}`}
                                                                >
                                                                    {hours.isWorking
                                        ...
                                        <div className="detail-section">
                                            ...
                                            <div className="detail-grid">
                                                ...
                                                <div className="detail-item">
                                                    <label>Status:</label>
                                                    <span
                                                        className={`status-badge ${selectedProvider.isActive ? 'active' : 'inactive'}`}
                                                    >
