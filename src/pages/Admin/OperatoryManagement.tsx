        ...
        <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    >
                        <div
                            style={{
                                ...
                                height: '20px',
                                borderRadius: '50%',
                                background: op.colorCode || '#3182ce'
                            }}
                        />
                        <h3>{op.name}</h3>
                        <p>
                            <strong>Sala:</strong> {op.room}
                        </p>
                        <p>
                        ...
                        {op.equipment?.length > 0 && (
                            <p>
                                <strong>Equipamentos:</strong> {op.equipment.join(', ')}
                            </p>
                        )}
                        <div style={{ display: 'flex', gap: '10px', marginTop: '15px' }}>
                            <Button variant="outline" size="sm" onClick={() => handleEdit(op)}>
                                Editar
                            </Button>
                            <button
            ...
            {showModal && (
                <Modal
                    ...
                    title={editing ? 'Editar Consultório' : 'Novo Consultório'}
                >
