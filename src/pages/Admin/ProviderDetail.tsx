        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
            <div>
              ...
              <p><strong>Telefone:</strong> {provider.phone || 'Não informado'}</p>
            </div>
            <div>
              <p><strong>Especialidades:</strong> {provider.specialties?.join(', ') || 'Não informado'}</p>
              <p><strong>Licença:</strong> {provider.licenseNumber || 'Não informado'}</p>
              <p><strong>Status:</strong> {provider.isActive ? 'Ativo' : 'Inativo'}</p>
            </div>
          </div>
        </div>
      )}
