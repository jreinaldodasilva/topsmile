        ...
        <div className="appointment-calendar">
            ...
            <div className="calendar-header">
                ...
                <div className="header-actions">
                    <button className="btn btn-primary" onClick={() => setShowNewAppointmentModal(true)}>
            ...
            <div className="calendar-controls">
                <div className="date-navigation">
                    <button className="btn btn-outline btn-sm" onClick={() => navigateDate('prev')}>
                    ...
                    <button className="btn btn-outline btn-sm" onClick={() => navigateDate('next')}>
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="appointment-time">
                                    ...
                                    <div className="appointment-date">
                                        {appointment.scheduledStart
                                            ? new Date(appointment.scheduledStart as string | Date).toLocaleDateString(
                                                  'pt-BR'
                                              )
                                            : 'Data não definida'}
                                    </div>
                                ...
                                <div className="detail-section">
                                    ...
                                    <div className="detail-grid">
                                        <div className="detail-item">
                                            <label>Tipo:</label>
                                            <span>
                                                {typeof selectedAppointment.appointmentType === 'object' &&
                                        ...
                                        <div className="detail-item">
                                            ...
                                            <span>
                                                {formatDateTime(selectedAppointment.scheduledStart)} -{' '}
                                        ...
                                        {selectedAppointment.actualStart && (
                                            <div className="detail-item">
                                                ...
                                                <span>
                                                    {formatDateTime(selectedAppointment.actualStart)} -{' '}
                                                    {selectedAppointment.actualEnd
                                                        ? formatTime(selectedAppointment.actualEnd)
                                                        : 'Em andamento'}
                                                </span>
                                            </div>
                                        )}
                                ...
                                <div className="detail-section">
                                    ...
                                    <div className="detail-grid">
                                        <div className="detail-item">
                                            <label>Nome:</label>
                                            <span>
                                                {typeof selectedAppointment.provider === 'object' &&
                                        ...
                                        <div className="detail-item">
                                            ...
                                            <span>
                                                {typeof selectedAppointment.provider === 'object' &&
                                                    selectedAppointment.provider?.specialties?.join(', ')}
                                            </span>
                                        </div>
                                    </div>
                                </div>
