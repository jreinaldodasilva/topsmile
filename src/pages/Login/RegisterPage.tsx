                ...
                <form className="auth-form" onSubmit={handleSubmit}>
                    ...
                    <fieldset className="form-fieldset">
                        ...
                        <div className="form-fields">
                            ...
                            <div className="form-field">
                                <label htmlFor="clinic.address.number" className="form-label">
                                    Número
                                </label>
                                <input
                            ...
                            <div className="form-field">
                                <label htmlFor="clinic.address.zipCode" className="form-label">
                                    CEP
                                </label>
                                <input
                    ...
                    <div className="form-options">
                        <div className="remember-me">
                            ...
                            />
                            <label htmlFor="terms-accepted" className="checkbox-label">
                                Eu aceito os{' '}
                                <a href="/terms" target="_blank" className="auth-link primary">
                                    Termos de Serviço
                                </a>
                            </label>
                        </div>
