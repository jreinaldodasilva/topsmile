          ...
          <div className="register-field">
            <div className="flex items-center">
              ...
              <label htmlFor="terms-accepted" className="ml-2 block text-sm text-gray-900">
                Eu li e aceito os <a href="/terms" target="_blank" className="text-indigo-600 hover:text-indigo-500">Termos de Serviço</a> e a <a href="/privacy" target="_blank" className="text-indigo-600 hover:text-indigo-500">Política de Privacidade</a>.
              </label>
            </div>
          </div>
