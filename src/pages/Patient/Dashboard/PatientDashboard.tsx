                ...
                <header className="dashboard-header">
                    <div className="header-content">
                        <div className="welcome-section">
                            <h1 className="welcome-title">Olá, {patientUser.patient.name.split(' ')[0]}!</h1>
                            <p className="welcome-subtitle">Bem-vindo ao seu portal do paciente</p>
                        </div>
                    </div>
                </header>
                    ...
                    <div className="dashboard-grid">
                        ...
                        <section className="dashboard-section quick-actions">
                            ...
                            <div className="actions-grid">
                                <button className="action-card" onClick={() => navigate('/patient/appointments/new')}>
                                ...
                                <button className="action-card" onClick={() => navigate('/patient/appointments')}>
                                    <div className="action-icon">
                                        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path
                                                strokeLinecap="round"
                                ...
                                <button className="action-card" onClick={() => navigate('/patient/profile')}>
                                    <div className="action-icon">
                                        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path
                                                strokeLinecap="round"
                        ...
                        <section className="dashboard-section upcoming-appointments">
                            <div className="section-header">
                                ...
                                <button className="view-all-button" onClick={() => navigate('/patient/appointments')}>
                                    Ver todos
                                </button>
                            </div>
                            ...
                            {isLoading ? (
                                ...
                                <div className="appointments-list">
                                    {upcomingAppointments.map((appointment: Appointment) => {
                                        const { date, time } = appointment.scheduledStart
                                                ...
                                                <div className="appointment-info">
                                                    <div className="appointment-primary">
                                                        ...
                                                        <p className="appointment-provider">
                                                            Dr.{' '}
                                                            {typeof appointment.provider === 'object' &&
                        ...
                        <section className="dashboard-section health-reminders">
                            ...
                            <div className="reminders-list">
                                ...
                                {patientUser?.patient?.medicalHistory?.allergies &&
                                    patientUser.patient.medicalHistory.allergies.length > 0 && (
                                ...
                                {patientUser?.patient?.medicalHistory?.medications &&
                                    patientUser.patient.medicalHistory.medications.length > 0 && (
                                        <div className="reminder-card reminder-medication">
                                            ...
                                            <div className="reminder-content">
                                                <h3>Medicações</h3>
                                                <p>
                                                    Você tem medicações registradas. Consulte seu dentista sobre
                                                    interações.
                                                </p>
                                ...
                                {upcomingAppointments.length === 0 && (
                                    <div className="reminder-card reminder-appointment">
                                        ...
                                        <div className="reminder-content">
                                            ...
                                            <p>
                                                Não encontramos nenhuma consulta futura. Mantenha sua saúde bucal em
                                                dia.
                                            </p>
                                            <button
                                                onClick={() => navigate('/patient/appointments/new')}
                                ...
                                {(!patientUser?.patient?.medicalHistory ||
                                    ...
                                    <div className="reminder-card reminder-profile">
                                        ...
                                        <div className="reminder-content">
                                            ...
                                            <p>
                                                Manter seu histórico médico atualizado nos ajuda a oferecer um melhor
                                                atendimento.
                                            </p>
                                            <button
