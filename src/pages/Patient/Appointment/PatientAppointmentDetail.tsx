                ...
                <main className="detail-main">
                    {loading ? (
                        ...
                        <div className="error-state">
                            <p>{error}</p>
                            <button onClick={fetchAppointment} className="retry-button">
                                Tentar novamente
                            </button>
                        </div>
                    ) : appointment ? (
                        <div className="appointment-detail-card">
                                ...
                                <section className="detail-section">
                                    ...
                                    <div className="info-grid">
                                        ...
                                        <div className="info-item">
                                            ...
                                            <p>
                                                Dr.{' '}
                                                {(appointment.provider as any)?.name || 'Profissional não informado'}
                                            </p>
                                            {(appointment.provider as any)?.specialties &&
                                                (appointment.provider as any).specialties.length > 0 && (
                                                    <small>
                                                        {(appointment.provider as any).specialties.join(', ')}
                                                    </small>
                                                )}
                                        </div>
                                        ...
                                        <div className="info-item">
                                            ...
                                            {(appointment.clinic as any)?.address && (
                                                <small>
                                                    {(appointment.clinic as any).address.street},{' '}
                                                    {(appointment.clinic as any).address.number}
                                                    {(appointment.clinic as any).address.city &&
                                                        ` - ${(appointment.clinic as any).address.city}`}
                                                </small>
                                            )}
                                        </div>
                            ...
                            {isUpcoming() && appointment.status !== 'cancelled' && (
                                <div className="detail-actions">
                                    <button className="action-btn secondary" onClick={handleReschedule}>
                                        Reagendar
                                    </button>
                                    <button
