            ...
            <div className="appointments-content">
                ...
                <header className="appointments-header">
                    <div className="header-content">
                        ...
                        <button className="new-appointment-btn" onClick={() => navigate('/patient/appointments/new')}>
                ...
                <main className="appointments-main">
                    {loading ? (
                        ...
                        <div className="empty-state">
                            ...
                            <button onClick={() => navigate('/patient/appointments/new')} className="schedule-button">
                                Agendar Consulta
                            </button>
                        </div>
                    ) : (
