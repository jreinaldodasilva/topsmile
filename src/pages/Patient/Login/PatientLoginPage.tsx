        ...
        <div className="auth-page">
            <div className="auth-container">
                <div className="auth-header">
                    ...
                    <h1 className="auth-title">Portal do Paciente</h1>
                    <p className="auth-subtitle">Acesse sua conta para gerenciar seus agendamentos e informações</p>
                </div>

                <form className="auth-form" onSubmit={handleSubmit}>
                    {(location.state as any)?.message && (
                        <div className="auth-success">{(location.state as any).message}</div>
                    )}
                    ...
                    <div className="auth-links">
                        <p>
                            <Link to="/patient/register" className="auth-link primary">
                                Criar conta
                            </Link>
                        </p>
                        <p>
