    ...
    const features: Feature[] = [
        {
            ...
            description:
                'Agende, reagende e cancele consultas com facilidade. Sistema inteligente de lembretes automáticos.',
            benefits: [
                'Agenda online 24/7',
        ...
        },
        {
            ...
            description:
                'Tenha insights poderosos sobre seu negócio com dashboards interativos e relatórios detalhados.',
            benefits: [
    ...
    const testimonials: Testimonial[] = [
        {
            ...
            content:
                'O TopSmile revolucionou a gestão da minha clínica. Consegui reduzir 80% do tempo gasto com tarefas administrativas e focar mais nos meus pacientes.',
            rating: 5,
        ...
        },
        {
            ...
            company: 'OrtoCenter',
            content:
                'A organização dos prontuários digitais é fantástica. Tenho acesso rápido ao histórico completo dos pacientes, o que melhora muito a qualidade do atendimento.',
            rating: 5,
        ...
        },
        {
            ...
            content:
                'Os relatórios financeiros me ajudaram a identificar oportunidades de crescimento que eu não via antes. Meu faturamento aumentou 40% em 6 meses.',
            rating: 5,
                    ...
                    <div className="hero__content">
                        <div className={`hero__text ${isVisible ? 'fade-in' : ''}`}>
                            ...
                            <p className="hero__description">
                                Gerencie consultas, prontuários e faturamento em uma única plataforma. Mais de 1.200
                                dentistas já otimizaram suas práticas com o TopSmile.
                            </p>
                            <div className="hero__actions">
                                <Button variant="primary" size="lg" onClick={() => scrollToSection('demo')}>
                                    Ver Demonstração
                    ...
                    <div className="features-showcase">
                        <div className="features-tabs">
                            {features.map((feature, index) => (
                                ...
                                >
                                    <div className="feature-tab__icon">{feature.icon}</div>
            ...
            <section className="cta-section" id="demo">
                <div className="container">
                    <div className="cta-content">
                        <h2 className="cta-title">Pronto para Revolucionar sua Clínica?</h2>
                        <p className="cta-description">
                            Junte-se a mais de 1.200 dentistas que já transformaram suas práticas. Comece seu teste
                            gratuito hoje mesmo.
                        </p>
