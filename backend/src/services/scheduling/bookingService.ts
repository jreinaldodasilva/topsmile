...
import { NotFoundError, ConflictError } from '../../utils/errors/errors';
import type { Appointment as IAppointment, Provider as IProvider, AppointmentType as IAppointmentType } from '@topsmile/types';
